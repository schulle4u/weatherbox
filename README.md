...
[Anleitung für den Linux-Dienst](docs/installation.md#linux-dienst-mit-systemd).
...
du die Dateien über einen [Webserver bereitstellen](docs/installation.md#dateien-per-http-bereitstellen).
